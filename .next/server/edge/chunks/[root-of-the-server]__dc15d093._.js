...
async function updateSession(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$supabase$2b$ssr$40$0$2e$6$2e$1_$40$supabase$2b$supabase$2d$js$40$2$2e$53$2e$0$2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(process.env.SUPABASE_URL, process.env.SUPABASE_ANON_KEY, {
        cookies: {
            getAll () {
    ...
    if (isAuthRoute) {
        ...
        if (user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/", ("TURBOPACK compile-time value", "http://localhost:3000")));
        }
    }
    ...
    if (!searchParams.get("noteId") && pathname === "/") {
        const { data: { user } } = await supabase.auth.getUser();
        if (user) {
            const { newestNoteId } = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3000")}/api/fetch-newest-note?userId=${user.id}`).then((res)=>res.json());
            if (newestNoteId) {
                ...
                const { noteId } = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3000")}/api/create-new-note?userId=${user.id}`, {
                    method: "POST",
                    headers: {
